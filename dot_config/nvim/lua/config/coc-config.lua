...
vim.g.coc_global_extensions = { 'coc-sql' }
vim.g.coc_global_extensions = { 'coc-html' }
vim.g.coc_global_extensions = { 'coc-spell-checker' }
vim.g.coc_global_extensions = { 'coc-sh' }
vim.g.coc_global_extensions = { 'coc-xml' }
vim.g.coc_global_extensions = { 'coc-cfn-lint' } ]]
...
--[[ function _G.show_docs()
	...
	elseif vim.api.nvim_eval('coc#rpc#ready()') then
		...
		vim.api.nvim_command('silent! !' .. vim.o.keywordprg .. ' ' .. cw)
	end
end
